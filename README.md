...
## [<img src="https://github.com/QuantLet/Styleguide-and-FAQ/blob/master/pictures/qloqo.png" alt="Visit QuantNet">](http://quantlet.de/) **indices_ccVStrad** [<img src="https://github.com/QuantLet/Styleguide-and-FAQ/blob/master/pictures/QN2.png" width="60" alt="Visit QuantNet 2.0">](http://quantlet.de/)
...
![Picture1](boxplot_log.png)

![Picture2](corr.png)

![Picture3](cullenfrey_crix.png)

![Picture4](cullenfrey_sp500.png)

![Picture5](density_log.png)

![Picture6](density_returns.png)

![Picture7](index_norm.png)

![Picture8](index_returns.png)

![Picture9](index_values.png)

![Picture10](performance.png)

![Picture11](vola_annualised.png)

![Picture12](vola_crix.png)

![Picture13](vola_dax.png)

![Picture14](vola_sp500.png)
...
descdist(vecrix, discrete = FALSE, boot = 1000, method = "unbiased",graph = TRUE, obs.col = "#BEBADA", obs.pch = 16, boot.col = "#FFED6F")
vesp500 = as.vector(rsp500)  
vesp500<-vesp500[!is.na(vesp500)]
descdist(vesp500, discrete = FALSE, boot = 1000, method = "unbiased",graph = TRUE, obs.col = "#BEBADA", obs.pch = 16, boot.col = "#FFED6F")
